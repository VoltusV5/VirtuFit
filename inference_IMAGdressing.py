...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_ckpt',
                        default="D:/Proga/VirtualFit/IMAGDressing-main_final/ckpt/IMAGDressing-v1_512.pt",
                        type=str)
    parser.add_argument('--cloth_path', type=str, required=True)
    parser.add_argument('--output_path', type=str, default="D:/Proga/VirtualFit/IMAGDressing-main_final/VirtuFit/output")
