...
# ===== ИМПОРТ ОБЪЕКТА ===== ТУТ!!!!!!!!!!!!!!!!!!!!!!!!
fbx_file_path = r"D:\Proga\VirtualFit\IMAGDressing-main_final\VirtuFit\models\MVP_MAN.fbx"  # Укажи путь к своему .fbx
clear_scene()
...
try:
    ...
    output_path = r"D:\Proga\VirtualFit\IMAGDressing-main_final\VirtuFit\video\render_output.mp4"
